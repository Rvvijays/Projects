...
$html = str_get_html(file_get_contents('https://cse.gndec.ac.in/sites/default/files/TT_17jul2018_data_and_timetable_data_and_timetable_rooms_days_horizontal.html'));
...
for($k=1; $k<=26; $k++){ //loops for all tables
